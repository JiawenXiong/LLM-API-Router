...
### 仪表盘
![仪表盘](./dashboard-page.jpg)

### 后端管理
![后端管理](./backend-management.jpg)

### 添加后端
![添加后端](./add-backend-modal.jpg)

### 路由策略
![路由策略](./routing-strategy.jpg)

### 请求日志
![请求日志](./request-logs.jpg)
...
| 字段 | 说明 | 示例 |
|------|------|------|
| 名称 | 自定义名称 | GPT-4、Claude 3 |
| API 类型 | OpenAI 兼容 或 Anthropic | OpenAI Compatible |
| Base URL | API 服务地址 | `https://api.openai.com` |
| API Key | 您的 API 密钥 | `sk-xxx...` |
| 模型名称 | 模型标识 | `gpt-4`、`claude-3-opus-20240229` |
